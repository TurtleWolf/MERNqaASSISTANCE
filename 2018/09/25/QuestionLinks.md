...
1. [Math.random function](https://www.udemy.com/modern-javascript-from-the-beginning/learn/v4/questions/5224172 "Yes, that should work.. it's just that by using floor you have a visual reference to the expected range, which can get lost in a larger block with more numbers to calculate. If you wanted t use ceil, I'd still use your expected max for the number but follow it with a minus instead
